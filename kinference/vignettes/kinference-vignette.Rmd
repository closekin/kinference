...
we won't recompute them. For demonstration, here's how to do it:


``` r
data(bluefin)
## if your data are stored 4-way (most likely)
## bluefin <- est_ALF_ABO_quick( bluefin)

## if your data are stored 6-way (rare and a bit specialised:
