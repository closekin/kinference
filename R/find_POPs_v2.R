...
#'
#' Trying to speed them up in C \emph{might} work, but would take too long at the moment. Or it might not. It entails nasty things like blocking the loops to be cache-friendly...
#'
